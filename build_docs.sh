...
find /root/scdocs_build/ -type f -exec sed -i -e "s_file:///usr/local/share/SuperCollider/SCClassLibrary/_https://github.com/supercollider/supercollider/tree/$SC_BRANCH/SCClassLibrary/_g" {} \;
find /root/scdocs_build/ -type f -exec sed -i -e "s_file:///usr/local/share/SuperCollider/HelpSource/_https://github.com/supercollider/supercollider/tree/$SC_BRANCH/HelpSource/_g" {} \; 
find /root/scdocs_build/ -type f -exec sed -i -e "s_/usr/local/share/SuperCollider/build/Install/share/SuperCollider/SCClassLibrary/_https://github.com/supercollider/supercollider/tree/$SC_BRANCH/SCClassLibrary/_g" {} \; 
